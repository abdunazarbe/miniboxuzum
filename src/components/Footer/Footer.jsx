                    ...
                    <div className="flex justify-between mb-[78.5px]">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex mb-[45.5px] gap-x-[23.56px]">
                                <a href="#" target="_blank" className="flex items-center gap-x-1">
                                    <img src={apple} alt="apple" />
                                    <span className="text-[#1F1F26] font-['InterMedium'] text-[12.8px]">AppStore</span>
                                </a>
                                <a href="https://play.google.com/store/apps/details?id=uz.uzum.app" target="_blank" className="flex items-center gap-x-1">
